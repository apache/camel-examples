...
/**
 * Explains why a caller was rejected, from the exception that stopped the request. When the SPIFFE Workload API refuses
 * a token, the java-spiffe library reports a generic "Error validating JWT SVID" and keeps the actual reason (expired,
