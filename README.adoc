...
| link:ai-tools-spiffe-opa/README.adoc[AI Tools with SPIFFE and OPA] (ai-tools-spiffe-opa) | AI | An example for guarding the tools of a Camel AI agent with SPIFFE workload identity and an Open Policy Agent policy evaluated in-process as WebAssembly
