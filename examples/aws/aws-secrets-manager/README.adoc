...
07:28:51.699 [org.apache.camel.example.MyApplication.main()] INFO  o.a.c.i.engine.AbstractCamelContext - Apache Camel 3.13.0-SNAPSHOT (AWS-secrets-manager) started in 537ms (build:27ms init:112ms start:398ms)
